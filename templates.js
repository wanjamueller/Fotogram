function framesTemplate(i) {
    ...
    <figure class="picture">
        <img id="pic${i}"  src="./assets/img/${myImages[i].file}" tabindex="0" aria-haspopup="image-dialog" aria-controls= "image-dialog" onclick="focusPicture(${i})" onkeypress="focusPicture(${i})" alt="./assets/img/${myImages[i].alt}">;
        </figure>
    `;
}
...
function dialogTemplate(i) {
    ...
    <div aria-labelledby="dialogTitle" class="dialog">
        <header class="dialog-header">
            ...
            <div class="close">
            <button tabindex="0" aria-label="close dialog" class="close-button" onclick="closeFocus()" onkeypress="closeFocus()" ><img src="./assets/icons/close_x.png" alt="click X to close the popup"></button>
            </div>
        </header>
